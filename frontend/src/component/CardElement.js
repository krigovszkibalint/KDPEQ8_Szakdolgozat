        ...
        <Card sx={{ minWidth: 275, mb: 3, mt: 3 }}>
            ...
            <CardContent >
                ...
                <Typography variant="body2">
                    Leírás: {description.split(" ").slice(0, 15).join(" ") + "..."}
                </Typography>
            </CardContent>
            <CardActions>
                <Button disableElevation variant='contained' size="small" startIcon={<AddIcon />}><Link style={{ textDecoration: "none", color: "white", boxShadow: 0 }} to={`/job/${id}`}>Részletek</Link></Button>
            </CardActions>
        </Card>
    );
}
